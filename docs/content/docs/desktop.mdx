...
## Use Glowbom OSS in the meantime

If you want to start building right now, [Glowbom OSS](./glowbom-oss) gives you the full local workflow for free. It runs in your browser and terminal, and works with the same Glowbom projects.
