...
4. **Make it production ready** with [Glowbom OSS](./glowbom-oss) running on your own computer. One of the coolest things is that the agent can update all codebases for iOS, Android, and web at the same time when you make follow-up changes.
...
[Glowbom OSS](./glowbom-oss) is the free, open source tool that takes your project and makes it ready to ship. It runs on your computer and uses the providers and models configured in OpenCode.
