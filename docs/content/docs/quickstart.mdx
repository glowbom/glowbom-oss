...
Press **Build**. Glowbom starts generating your prototype. You can see the progress as it works.

![Glowbom generating a prototype from the drawing](/quickstart/step-2-prompt.jpg)

### Step 4. Try the prototype

When it is done, you get a working prototype you can play with right in the browser. Glowbom generates the images, the code, and the whole idea for you.
...
Use [Glowbom OSS](./glowbom-oss) to take your Glowbom project and make it production ready with AI coding agents, all running on your machine.

![Glowbom OSS loaded with a project](/quickstart/step-5-glowbyoss.jpg)

See the [Glowbom OSS guide](./glowbom-oss) for setup instructions and full details.
